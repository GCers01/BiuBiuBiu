 ...
 */
public class ChangeAlarmFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static ChangeAlarmFragment newInstance(int id) {

        ChangeAlarmFragment fragment = new ChangeAlarmFragment();
